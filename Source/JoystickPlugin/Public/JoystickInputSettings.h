...
public:
	UPROPERTY(Transient, BlueprintReadOnly, VisibleAnywhere, Category="Information")
	...
	UPROPERTY(Transient, VisibleAnywhere, Category="Joystick Settings", meta=(ToolTip="A container to hold the configurations loaded from the profiles directory"))
